...
public class CmisQueryServlet extends HttpServlet {

    private static final long serialVersionUID = 6010762203253206726L;
    private static final Logger logger = Logger.getLogger(CmisQueryServlet.class);
            ...
            throws ServletException, IOException
    {
        ...
        httpSession.setAttribute("message", calcResult);
        ServletContext context = this.getServletContext();
        RequestDispatcher dispatcher = context.getRequestDispatcher("/jsp/chart.jsp");
